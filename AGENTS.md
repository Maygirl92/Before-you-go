...
- Country labels use the Chinese editorial serif in pure black `#000000` without an outline. Ten zoom levels progressively reveal all mapped country names without overlap at maximum zoom. Do not add original-language sublabels, selection grounds or an availability legend.
